...
import { Eye, EyeOff, Hexagon } from 'lucide-react'; // Dùng Hexagon làm logo giả định
      ...
      <div className="bg-white w-full max-w-[440px] rounded-xl shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] border border-gray-100 p-8 sm:p-10">
        ...
        <div className="text-center mb-8">
          <div className="w-10 h-10 bg-gray-50 rounded-full flex items-center justify-center mx-auto mb-4 text-gray-400">
             {/* Icon mũi tên login (optional) hoặc để trống như mẫu */}
             <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
              <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15M12 9l-3 3m0 0l3 3m-3-3h12.75" />
            </svg>
          </div>
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Log in with your work email</h1>
          <p className="text-gray-500 text-sm">Use your work email to log in to your team workspace.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <Link to="/forgot-password" class="text-sm text-indigo-600 hover:text-indigo-700 font-medium hover:underline">
                Forgot password?
              </Link>
            </div>
