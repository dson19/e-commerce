...
const DB_TABLET_CATEGORIES = [
    // --- Các mục ĐÃ CÓ trong Database (Giữ nguyên ID để tránh trùng lặp) ---
    { id: 23, name: 'iPad',        keywords: ['ipad', 'apple', 'mini', 'air', 'pro', 'gen'] },
    { id: 24, name: 'Samsung Tab', keywords: ['samsung', 'galaxy', 'tab', 's6', 's7', 's8', 's9', 'a7', 'a8'] },
    { id: 25, name: 'Xiaomi Pad',  keywords: ['xiaomi', 'redmi', 'pad', 'mipad', 'mi pad'] },
    { id: 26, name: 'Lenovo Tab',  keywords: ['lenovo', 'tab', 'yoga', 'm10', 'p11'] },
];

const DEFAULT_BRAND_ID = 25;
const DEFAULT_CATEGORY_ID = 44;
let count = 0;
(async () => {
    ...
    const url = 'https://hoanghamobile.com/tablet';
    ...
    saveProductsSmart('tablets.json', finalProducts);
...
function detectCategory(productName) {
    ...
    const nameLower = productName.toLowerCase();
    for (const cat of DB_TABLET_CATEGORIES) {
