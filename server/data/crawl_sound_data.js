...
const DB_AUDIO_CATEGORIES = [
    // --- Các mục ĐÃ CÓ trong Database (ID 32 -> 38) ---
    { id: 32, name: 'AirPods',  keywords: ['airpods', 'apple', 'airpod', 'max', 'pro'] },
    { id: 33, name: 'JBL',      keywords: ['jbl', 'partybox', 'tune', 'live', 'tour', 'clip', 'go'] },
    { id: 34, name: 'Sony',     keywords: ['sony', 'wh-', 'wf-', 'xb', 'ult'] },
    { id: 35, name: 'Marshall', keywords: ['marshall', 'acton', 'stanmore', 'woburn', 'emberton', 'willen', 'motif', 'minor'] },
...
(async () => {
    ...
    const url = 'https://hoanghamobile.com/loa-tai-nghe?filters=%7B%7D&search=true&pmin=3%2C400%2C000&pmax=15%2C900%2C000';
    ...
    saveProductsSmart('sounds.json', finalProducts);
...
function detectCategory(productName) {
    ...
    const nameLower = productName.toLowerCase();
    for (const cat of DB_AUDIO_CATEGORIES) {
