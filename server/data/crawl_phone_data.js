...
const DB_PHONE_CATEGORIES = [
    { id: 7,  name: 'iPhone',   keywords: ['iphone', 'apple'] },
    { id: 8,  name: 'Samsung',  keywords: ['samsung', 'galaxy'] },
    { id: 9,  name: 'Xiaomi',   keywords: ['xiaomi', 'redmi', 'poco', 'mi '] },
    { id: 10, name: 'OPPO',     keywords: ['oppo', 'reno', 'find'] },
    { id: 11, name: 'Vivo',     keywords: ['vivo', 'iqoo'] },
    { id: 12, name: 'Realme',   keywords: ['realme', 'narzo', 'gt'] },
    { id: 13, name: 'Nokia',    keywords: ['nokia'] },
    { id: 14, name: 'Asus',     keywords: ['asus', 'rog'] },
];
const DEFAULT_BRAND_ID = 25;
const DEFAULT_CATEGORY_ID = 42;
let count = 0;
(async () => {
    ...
    products.forEach(p => {
        ...
        p.categoryId = detectPhoneCategory(p.name);
    });
    ...
    saveProductsSmart('phones.json', finalProducts);
...
function detectPhoneCategory(productName) {
    if (!productName) return DEFAULT_CATEGORY_ID;
    const nameLower = productName.toLowerCase();
    for (const cat of DB_PHONE_CATEGORIES) {
