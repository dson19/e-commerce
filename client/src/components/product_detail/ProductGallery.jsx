...
const ProductGallery = ({ gallery, mainImage, setMainImage }) => {
  return (
      ...
      <div className="flex lg:flex-col gap-3 overflow-x-auto lg:overflow-y-auto lg:max-h-[500px] no-scrollbar py-1 lg:py-0">
        {gallery.map((img) => (
          <button
            ...
            className={`w-16 h-16 lg:w-20 lg:h-20 flex-shrink-0 border-2 rounded-lg overflow-hidden bg-white p-1 transition-all ${
              mainImage === img.url
