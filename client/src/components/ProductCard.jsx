...
const ProductCard = ({ product }) => {
    // Tạo URL sản phẩm động, sử dụng ID (Giả định Route là /product/:productId)
    const productUrl = `/product/${product.id}`; 
    
    return (
        // 👈 BƯỚC 2: Dùng Link thay thế cho div bao ngoài cùng
        <Link 
            to={productUrl}
        ...
        >
            ...
            <div className="h-40 flex items-center justify-center mb-2 overflow-hidden">
                {/* Lấy link ảnh, loại bỏ phần tham số resize nếu có */}
                <img 
