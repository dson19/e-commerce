    ...
    return (
        <div className="bg-white rounded-2xl border-2 border-[#004535] shadow-lg p-8 text-center animate-in zoom-in duration-500 relative overflow-hidden">
            ...
            <div className="bg-white p-2 rounded-xl border border-gray-200 inline-block mb-6 shadow-sm">
                <img
                    src={`https://img.vietqr.io/image/MB-0398277699-compact2.png?amount=${order.grand_total}&addInfo=${encodeURIComponent(`OrderID${order.order_id}`)}&accountName=Dang%20Hoang%20Son`}
                    alt="VietQR Payment"
            ...
            <div className="space-y-2 text-sm">
                ...
                <p className="text-gray-500">Nội dung: <span className="font-bold text-gray-800 text-base">OrderID{order.order_id}</span></p>
            </div>
